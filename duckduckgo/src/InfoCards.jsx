...
const info_text= {
    card_1_info: 'Navega como siempre y nosotros nos encargamos del resto. Te ofrecemos buscador, bloqueador de rastreadores y mejora de encriptación todo en una extensión de Safari',
...
const InfoCards = () => {
    return (
        <div className="info_cards_cont">
            <Card img="src/assets/laptop.svg" title="Privacidad para Safari" info={info_text.card_1_info}/>
